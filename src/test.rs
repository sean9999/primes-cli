...
mod tests {
    ...
    fn test_near_with_non_prime() {
        ...
        let got: Vec<usize> = primes::near(3000 as usize);
        assert!(want == got)
    }
    ...
    fn test_near_with_prime() {
        ...
        let got: Vec<usize> = primes::near(3001 as usize);
        assert!(want == got)
    }
    ...
    fn test_between_50_60() {
        ...
        let got: Vec<usize> = primes::between(50 as usize, 60 as usize);
        assert!(want == got)
    }
    ...
    fn test_between_two_primes() {
        ...
        let got: Vec<usize> = primes::between(11 as usize, 17 as usize);
        assert!(want == got)
    }
